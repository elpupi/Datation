...
class TimelandClient implements \timeland_thrift\TimelandIf {
  ...
  {
    $args = new \timeland_thrift\Timeland_compute_args();
    $args->file = $file;
  ...
  public function recv_compute()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\timeland_thrift\Timeland_compute_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \timeland_thrift\Timeland_compute_result();
